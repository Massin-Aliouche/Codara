          ...
          {faq.map((item, index) => (
            ...
            >
              <button
                ...
                className="w-full px-6 py-5 flex items-center justify-between text-left hover:bg-[var(--surface-hover)] transition-colors"
              >
                ...
                {openIndex === index ? (
                  ...
                  <ChevronDown className="w-5 h-5 text-[var(--text-subtle)] flex-shrink-0" />
                )}
              </button>
              {openIndex === index && (
